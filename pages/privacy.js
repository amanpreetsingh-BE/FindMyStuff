  ...
  return (
    <main className="bg-primary text-white">
      ...
      <div className="flex flex-col mx-10">
        ...
        <p className=" text-base font-medium mb-5 py-3 px-3">
          {t("privacy:p7")} <br /> <br /> {t("privacy:p8")}
        </p>
        ...
        <p className=" text-base font-medium mb-5 py-3 px-3">
          {t("privacy:p3")} <br /> <br /> {t("privacy:p9")} <br /> <br />{" "}
          {t("privacy:p10")} <br /> <br /> {t("privacy:p11")} <br /> <br />{" "}
          {t("privacy:p12")} <br /> <br /> {t("privacy:p13")} <br /> <br />{" "}
          {t("privacy:p14")} <br /> <br /> {t("privacy:p15")}
        </p>
        <ul className=" text-base font-medium mb-5 px-12 list-disc">
          <li>{t("privacy:li5")}</li>
          <li>{t("privacy:li6")}</li>
        ...
        <p className=" text-base font-medium mb-5 py-3 px-3">
          {t("privacy:p16")} <br /> <br /> {t("privacy:p17")} <br /> <br />{" "}
          {t("privacy:p18")} <br /> <br /> {t("privacy:p19")}
        </p>
        <ul className=" text-base font-medium mb-5 px-12 list-disc">
        ...
        <p className=" text-base font-medium mb-5 py-3 px-3">
          {t("privacy:p20")} <br /> <br /> {t("privacy:p21")} <br /> <br />{" "}
          {t("privacy:p22")}
        </p>
        <ul className=" text-base font-medium mb-5 px-12 list-disc">
        ...
        <p className=" text-base font-medium mb-5 py-3 px-3">
          {t("privacy:p24")} <br /> <br /> {t("privacy:p25")}
        </p>
        <ul className=" text-base font-medium mb-5 px-12 list-disc">
