...
/*
 * Description : Allow to add new QRs to DB
...
async function addQRtoDB(arr) {
  arr.forEach(async (element) => {
    await app.firestore().collection("QR").doc(element).set({
      email: "",
      activate: false,
      relais: null,
      jetons: 1,
