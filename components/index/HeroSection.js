    ...
    return (
        <section className="relative flex flex-col items-center justify-evenly bg-primary w-full h-screen -mt-20">
            <motion.div whileHover={{ scale: 1.05 }} initial={{opacity:0}} animate={{opacity:1}}>
                <div className={"relative flex justify-center items-center group mt-40 w-48 h-48 sm:w-64 sm:h-64 transition ease-in-out duration-[200ms] " + opacity}>
            ...
            <p className={"relative my-3 text-gray-400 font-bold text-center text-xs max-w-xs sm:text-sm sm:max-w-sm md:text-md md:max-w-md lg:text-lg lg:max-w-lg transition ease-in-out duration-[200ms] " + opacity}>{t('home:description')} </p>
