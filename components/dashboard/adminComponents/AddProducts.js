  ...
  const handleSubmit = async (e) => {
    ...
    if (!image && !file) {
      ...
      const storageRef = ref(
        storage,
        `products/${type.current.value}/${file.name}`
      );
      uploadBytes(storageRef, file).then((snapshot) => {
        getDownloadURL(storageRef).then(async (url) => {
          ...
          if (responseJSON.received) {
            ...
            quantity.current.value = "";
            return toast.error(
              "An error has occur, please contact amanpreet@outlook.be !"
            );
          }
        });
      });
  ...
  return (
    <div className="mt-20 mx-12 lg:mx-auto px-12 py-12 bg-[#1B212E] max-w-4xl ">
      ...
      <div className="grid grid-cols-2 place-items-center font-bold text-xl">
        <div className="col-span-2 lg:col-span-1">
          ...
          <div className="mb-2">
            ...
            <div className="mt-1">
              <input
                id="name"
                placeholder="Mandela, Square, etc."
                name="name"
                type="text"
                ref={name}
                required
          ...
          <div className="mb-2">
            ...
            <div className="mt-1">
              <input
                id="color"
                placeholder="darkGray, blueRoyal, etc."
                name="color"
                type="text"
                ref={color}
              />
        ...
        <div
          className={
            "flex justify-center items-center flex-col w-[300px] h-[250px] mt-4 lg:mt-0 lg:w-full lg:h-full col-span-2 lg:col-span-1 " +
            dashedBorder
          }
        >
          {image ? (
            ...
            <div>
              ...
              <label
                htmlFor="file"
                className="font-medium cursor-pointer bg-red-500 hover:bg-red-600 px-12 py-4 flex justify-center items-center"
              >
        ...
        <div className="col-span-2 mt-8">
          <button
            ...
            className="px-24 py-4 font-medium bg-emerald-500 hover:bg-emerald-600 rounded-lg"
          >
            Créer le produit
          </button>
        </div>
