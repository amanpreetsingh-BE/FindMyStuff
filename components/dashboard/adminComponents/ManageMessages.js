  ...
  messagesJSON.forEach((element) => {
    ...
    tr.push(
      <tr
        ...
        onClick={() => openContactModal(message, id, replied, email, fullname)}
        className={
    ...
    <div className="space-y-4 mt-20 ">
      ...
      <div className="overflow-y-scroll h-[600px]">
        <table className="border-collapse outline-none w-3/4 max-w-5xl mx-auto shadow-lg">
          ...
          {messagesJSON.length > 0 ? <tbody className="">{tr}</tbody> : ""}
        </table>
      </div>
              ...
              <div className="grid gap-4 place-items-center grid-cols-2">
                ...
                <div>
                  {file ? (
                    ...
                    <>
                      ...
                      <label
                        htmlFor="file"
                        className="font-medium cursor-pointer text-white bg-indigo-500 hover:bg-indigo-600 px-8 py-4 flex justify-center items-center"
                      >
                ...
                <div className="col-span-2">
                  <button
                    ...
                    className="px-8 py-4 bg-emerald-600 hover:bg-emerald-500 rounded-md text-white"
                  >
                    Send email
                  </button>
                </div>
