    ...
    products.forEach((product) => {
      ...
      cards.push(
        <div
          ...
          className="flex flex-col justify-center items-center w-52 h-52 sm:w-72 sm:h-72 rounded-lg bg-[#1c222e] shadow-lg hover:shadow-lg cursor-pointer"
        >
      ...
      <>
        <div className="mt-4 border-2 rounded-lg px-4 pt-4 mx-4 ">
          ...
          <button
            ...
            className="max-w-lg py-4 px-8 mx-auto my-4 font-bold text-md bg-emerald-500 hover:bg-emerald-600 rounded-lg flex"
          >
      ...
      <div className="px-12">
        ...
        <div className="mt-4 border-2 rounded-lg px-2 mx-4">
          <div className="flex justify-center items-center space-x-8">
            <h1 className="text-md py-2 text-center font-mono">
              {t("dashboard:user:prodPage:tokenState")} {modalJetons}{" "}
            </h1>
          </div>
          <button
            onClick={handleReload}
            className="max-w-xl py-3 px-2 mx-auto my-2 font-bold text-md bg-emerald-500 hover:bg-emerald-600 rounded-lg flex"
          >
            ...
            <div className="w-full h-full flex flex-col justify-start items-center">
              ...
              {rd ? (
                ...
                <div className="mt-12 grid place-items-center gap-4 grid-cols-2">
                  <div
                    onClick={() => setRd(true)}
                    className="bg-indigo-500 cursor-pointer w-28 h-28 px-4 py-4 sm:w-40 sm:h-40 sm:px-12 sm:py-12 rounded-lg text-center flex justify-center items-center text-white font-bold"
                  >
                    {t("dashboard:user:prodPage:l1")}
                  </div>
                  <div
                    onClick={() => setRj(true)}
                    className="bg-emerald-500 cursor-pointer w-28 h-28 px-4 py-4 sm:w-40 sm:h-40 sm:px-12 sm:py-12 rounded-lg text-center flex justify-center items-center text-white font-bold"
                  >
