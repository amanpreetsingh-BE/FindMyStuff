          ...
          <div>
            {renderOption == "prod" ? (
              ...
              <Notifications
                ...
                t={t}
                toast={toast}
                userNotificationsJSON={userNotificationsJSON}
                hostname={hostname}
                motion={motion}
                email={email}
              />
          ...
          <div className="absolute">
            <Modal showModal={showModal} setShowModal={setShowModal}>
              <Swiper
                ...
                className="h-full w-full font-nxt "
              >
                <SwiperSlide>
                  <div className="flex h-full justify-center items-center flex-col">
                    <h1 className="text-lg sm:text-xl font-mono font-bold text-primary">
                      {t("dashboard:welcomeModal:h1")}
                    </h1>
                ...
                <SwiperSlide>
                  <div className="flex h-full justify-center items-center flex-col">
                    <h1 className="text-lg sm:text-xl font-mono mx-8 text-center font-bold text-primary">
                      {t("dashboard:welcomeModal:h3")}
                    </h1>
                    <div className="mx-8 text-center">
                      <p className="mb-2 mt-1 text-gray-800">
