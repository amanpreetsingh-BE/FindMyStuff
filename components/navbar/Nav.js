...
function Nav({useContext, UserContext, Image, Link, locale, toggle, t}) {
    ...
    return (
        <nav className="z-20 font-nxt flex top-0 sticky h-24 bg-primary">
            <div className="flex justify-between pl-10 pr-10 h-full w-full">
                ...
                <div onClick={toggle} className="z-index-20 flex items-center justify-center h-full lg:hidden">
