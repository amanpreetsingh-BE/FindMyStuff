                ...
                <Link passHref href="/">
                    <div>
                        <div className="hidden md:pt-3 md:h-full md:flex md:justify-center md:items-center">
                            <Image className={"cursor-pointer"} src={darkLogo ? logo_blk:logo_white} width={'200'} height={'40'} alt={'logo'}/>
                        </div>
                        <div className="md:hidden -ml-3 pt-3 h-full flex justify-center items-center">
                            <Image className={"cursor-pointer"} src={darkLogo ? logo_blk:logo_white} width={'150'} height={'30'} alt={'logo'}/>
                        </div>
                    </div>
                </Link>
            </div>
